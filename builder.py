...
class make_env:
    ...
    def get_src(self) -> None:
        subprocess.run(['git', 'clone', 'https://github.com/donnyboi1234/Repyrean.git'], cwd=self.build_dir)
        shutil.move(os.path.join(self.build_dir, 'repyrean', 'src'), self.build_dir)
